 ...
 * </p>
 */
public class GetFeatureInfoReaderV11 extends AbstractRequestReader<GetFeatureInfoRequest> {


    public GetFeatureInfoReaderV11() {
    ...
    public GetFeatureInfoRequest readURLParameters(Map<String, String> queryParameters) throws OWSException {
        ...
        while (it.hasNext()) {
            ...
            try {
                ...
                // x
                else if (argName.equalsIgnoreCase("X")) {
                    request.setX(Integer.parseInt(argValue));
                }

                // y
                else if (argName.equalsIgnoreCase("Y")) {
    ...
    public GetFeatureInfoRequest readXMLQuery(DOMHelper dom, Element requestElt) throws OWSException {
        throw new WMSException(noXML + "WMS 1.1.1 GetFeatureInfo");
    }
    ...
    protected void checkParameters(GetFeatureInfoRequest request, OWSExceptionReport report) throws OWSException {
        ...
        // need X
        if (request.getX() == -1)
            report.add(new WMSException(OWSException.missing_param_code, "X"));

        // need Y
        if (request.getY() == -1)
            report.add(new WMSException(OWSException.missing_param_code, "Y"));
